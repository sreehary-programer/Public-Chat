 ...
 */
export function isScrolledNearBottom(container) {
 ...
 */
export function scrollToBottom(container, opts = {}) {
 ...
 */
export function smartScrollToBottom(container, opts = {}) {
 ...
 */
export function initScrollSentinel(container) {
    if (sentinel)
        return; // idempotent
 ...
 */
export function scrollSentinelIntoView(behavior = "smooth") {
