...
const seedMessages = [
    {
        ...
        sender_name: "maya.r",
        message_text: "Hey team — I just pushed the new auth middleware to the staging branch. Can someone take a look before we merge?",
    },
    {
        id: "msg_002",
        ...
        channel_id: "ch_general",
        sender_name: "j.park",
        message_text: "On it. Which file is the entry point? The middleware folder has like 8 files now",
    },
    {
        id: "msg_003",
        ...
        channel_id: "ch_general",
        sender_name: "you",
        message_text: "It's `src/middleware/auth.ts` — exports a single `withAuth` wrapper. Should be pretty readable.",
    },
    {
        id: "msg_004",
        ...
        channel_id: "ch_general",
        sender_name: "maya.r",
        message_text: "Looks clean. Should we handle token expiry separately or bubble it up from `verifyToken`?",
    },
    {
        id: "msg_005",
        ...
        channel_id: "ch_general",
        sender_name: "you",
        message_text: "Let's handle it inside `verifyToken` and throw a typed error. That way every route gets consistent 401 behaviour without extra boilerplate.",
    },
    {
        id: "msg_006",
        ...
        channel_id: "ch_general",
        sender_name: "j.park",
        message_text: "Agreed. Also — are we still on the Pages Router or should we switch the handler typing to App Router?",
    },
    {
        id: "msg_007",
        ...
        channel_id: "ch_general",
        sender_name: "you",
        message_text: "Good catch. We're migrating next sprint — keep Pages Router types for now and flag it with a TODO so it's obvious in the diff.",
    },
    {
        id: "msg_008",
        ...
        channel_id: "ch_general",
        sender_name: "maya.r",
        message_text: "Perfect. I'll add the TODO and push a small update. PR should be review-ready in ~10 mins.",
    },
];
// ─── Singleton state ──────────────────────────────────────────────────────────
export const state = {
 ...
 */
export function addMessage(text, senderName = state.localUser) {
    const msg = {
        id: `msg_${Date.now()}`,
